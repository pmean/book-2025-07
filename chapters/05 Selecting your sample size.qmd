...
Simon SD. Sample chapter, the first three steps in selecting an appropriate sample size. PMean blog, 2010-07-24. Available in [html format][ref05-simon-2010].

[ref05-simon-2010]: http://www.new.pmean.com/chapter-sample-size/
